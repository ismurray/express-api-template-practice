...
1.  Rename the directory from express-api-template-practice -> your-app-name.
1.  Empty [`README.md`](README.md) and fill with your own content.
1.  Move into the new project and `git init`.
1.  Replace all instances of `'express-api-template-practice'` with your app name. This
